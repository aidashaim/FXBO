      ...
      body: GestureDetector(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              AppLogo(),
              AppDropDownButton(title: 'Title', initialValue: 'Mr', itemsList: itemsList, hintText: '123'),
              AppTextField(
                text: 'First name',
              ...
              AppDropDownButton(initialValue: 'Russia', itemsList: countryList, hintText: 'Country'),
              AppTextField(
                text: 'Phone number',
                type: TextInputType.emailAddress,
              ),
